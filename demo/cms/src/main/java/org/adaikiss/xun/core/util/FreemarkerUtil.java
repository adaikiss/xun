...
public class FreemarkerUtil {
	 ...
	 */
	public static String parseString(String key, Map<String, TemplateModel> map)
			throws TemplateModelException {
	 ...
	 * @throws TemplateModelException
	 */
	public static Integer parseInteger(String key,
			Map<String, TemplateModel> map) throws TemplateModelException {
		...
		if (templateModel instanceof TemplateNumberModel)
			return Integer.valueOf(((TemplateNumberModel) templateModel)
	...
	public static Integer parseInteger(String key,
			Map<String, TemplateModel> map, Integer defaultValue) {
		Integer value;
		try {
	...
	public static Long parseLong(String key,
		...
		if (templateModel instanceof TemplateNumberModel)
			return Long.valueOf(((TemplateNumberModel) templateModel)
					.getAsNumber().intValue());
		throw new TemplateModelException("The \"" + key
				+ "\" parameter must be a Long.");
	}

	public static BigDecimal parseBigDecimal(String key,
			Map<String, TemplateModel> map) throws TemplateModelException {
		TemplateModel templateModel = (TemplateModel) map.get(key);
		if (templateModel == null)
			return null;
		...
		if (templateModel instanceof TemplateNumberModel)
			return BigDecimal.valueOf(((TemplateNumberModel) templateModel)
					.getAsNumber().doubleValue());
		throw new TemplateModelException("The \"" + key
				+ "\" parameter must be a bigdecimal.");
	}
	...
	public static Boolean parseBoolean(String key,
		...
		if (templateModel instanceof TemplateBooleanModel)
			return Boolean.valueOf(((TemplateBooleanModel) templateModel)
					.getAsBoolean());
		throw new TemplateModelException("The \"" + key
	 ...
	 * @throws TemplateModelException
	 */
	public static Date parseDate(String key, Map<String, TemplateModel> map)
			throws TemplateModelException {
		TemplateModel templateModel = (TemplateModel) map.get(key);
		if (templateModel == null)
			return null;
		if (templateModel instanceof TemplateScalarModel) {
			...
			if (StringUtils.isEmpty(str))
				return null;
			try {
				String[] dataFormats = { "yyyy-MM", "yyyyMM", "yyyy/MM",
	 ...
	 * @throws TemplateModelException
	 */
	public static Object parseObject(String key, Map<String, TemplateModel> map)
			throws TemplateModelException {
		TemplateModel templateModel = (TemplateModel) map.get(key);
		if (templateModel == null)
			return null;
