...
/**
 * copied from SpringSide4 springside4\modules\extension\src\main\java\org\springside\modules\cache\memcached
 * 对SpyMemcached Client的二次封�?提供常用的Get/GetBulk/Set/Delete/Incr/Decr函数的同步与异步操作封装.
 * 
...
public class SpyMemcachedClient implements DisposableBean{
	...
	public <T> Map<String, T> getBulk(Collection<String> keys) {
		try {
			...
			Map<String, T> result = new HashMap<String, T>(bulk.size());
